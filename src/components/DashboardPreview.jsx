...
export default function DashboardPreview() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-[620px] rounded-[26px] border border-[#D9E6D1] bg-white p-3.5 sm:p-5 shadow-2xl shadow-emerald-950/10">
      
      {/* Top Header Bar */}
      <div className="flex items-center gap-2 border-b border-slate-100 pb-3 text-xs font-semibold text-slate-500">
        <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#7CA45E] text-white font-bold">
          T
        </div>
      ...
      <div className="mt-3 grid grid-cols-[120px_1fr] gap-3 sm:grid-cols-[145px_1fr]">
        ...
        {/* Sidebar */}
        <aside className="rounded-2xl bg-[#F4F7F2] p-2 text-[10px] font-bold text-slate-600 sm:p-3 sm:text-xs border border-[#D9E6D1]">
          <p className="mb-2.5 px-1 text-[9px] font-black uppercase tracking-widest text-[#5F7A67]">
            Workspace
          </p>
          {nav.map((Icon, i) => (
            <div 
              ...
              className={`mb-1 flex items-center gap-2 rounded-xl px-2.5 py-2 transition-colors ${
                i === 0 
                  ? "bg-[#7CA45E] text-white font-bold shadow-xs" 
                  : "text-slate-600 hover:bg-[#EBF5E4]"
              }`}
            >
        ...
        <main className="min-w-0 space-y-3">
          ...
          <div className="flex items-start justify-between">
            ...
            <button className="rounded-lg bg-[#E4EEFB] border border-[#C5D9F8] px-2.5 py-1 text-[10px] font-extrabold text-[#2A488E]">
              + Create
            </button>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2">
            {[
              ...
              <div key={label} className="rounded-xl border border-slate-100 bg-[#FAFCF9] p-2 text-center">
          ...
          <div className="rounded-xl bg-gradient-to-r from-[#7CA45E] to-[#658A4A] p-3 text-white shadow-md">
            <div className="flex justify-between items-center">
              ...
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-white text-[#7CA45E] shadow-sm">
          ...
          <div className="rounded-xl border border-slate-100 bg-white p-2.5">
            <div className="flex justify-between text-[10px]">
              ...
              <span className="font-bold text-[#7CA45E]">82% complete</span>
            </div>
            <div className="mt-1.5 h-1.5 rounded-full bg-slate-100">
              <div className="h-full w-[82%] rounded-full bg-[#7CA45E]" />
            </div>
